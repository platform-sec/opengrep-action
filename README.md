...
| `opengrep-version` | `1.30.0` | OpenGrep version to install. Use an explicit version for reproducibility or `latest` to opt into the newest release at runtime. |
...
with:
  opengrep-version: '1.30.0'
  opengrep-checksum: '35779bdd72e92129c8df2a77f0c55e8c08356801ea92591ef32108d6b28d564c'
```
