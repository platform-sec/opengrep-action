...
| `opengrep-version` | `1.29.0` | OpenGrep version to install. Use an explicit version for reproducibility or `latest` to opt into the newest release at runtime. |
...
with:
  opengrep-version: '1.29.0'
  opengrep-checksum: '3365ef49d04893e01338d85d9bbd49b2bd5261ad4c9c0df0a6a0f8d44232ae13'
```
